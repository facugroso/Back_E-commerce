...
module.exports = async () => {
  ...
  orders.push(
    ...
    },
    {
        ...
        {
        adress:faker.address.streetAddress({ useFullAddress: true }),
        products: [{name:"HyperX Pulsefire Haste 2 - Wireless Gaming Mouse", price:89.99, quantity: 2},{name: "HyperX Armada 27 QHD Gaming Monitor", price: "399.99", quantity: 1} ],
        status: "Sent",
        payment:"PayPal",
        userId: Math.floor(Math.random() * 8) + 1,
        },
        {
        adress:faker.address.streetAddress({ useFullAddress: true }),
        products: [{name: "HyperX Armada 27 QHD Gaming Monitor", price: "399.99", quantity: 2} ],
        status: "Delivered",
        payment:"Crédito",
        userId: Math.floor(Math.random() * 8) + 1,
        },
        {
        adress:faker.address.streetAddress({ useFullAddress: true }),
        products: [{name:"HyperX Pulsefire Haste - Naruto Edition - Gaming Mouse", price: 59.99 , quantity: 3 }],
        status: "Paid",
        payment:"MercadoPago",
        userId: Math.floor(Math.random() * 8) + 1,
        },
        {
        adress:faker.address.streetAddress({ useFullAddress: true }),
        products: [{name:"HyperX Pulsefire Haste - Naruto Edition - Gaming Mouse", price: 59.99 , quantity: 2 }, {name: "HyperX Cloud Alpha - Naruto Edition - Gaming Headset", price: 109.99, quantity: 2} ],
        status: "Sent",
        payment:"Crédito",
        userId: Math.floor(Math.random() * 8) + 1,
        }
